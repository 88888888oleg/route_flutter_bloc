...
class FirstPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return RouteObserverListener(
      didPopNext: () {
        print('Safe didPopNext from RouteObserverListener when use popUntilGuarded on page 1');
      },
      child: Scaffold(
...
class SecondPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RouteObserverListener(
      didPopNext: () {
        print('didPopNext from RouteObserverListener, not triggered when use popUntilGuarded (page 2)');
      },
      child: Scaffold(
